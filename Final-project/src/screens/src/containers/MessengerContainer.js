...
if (Platform.OS == 'ios') {
  ...
  var UserName =  String(Math.random());
  var AvatarUrlST = 'https://source.unsplash.com/random';
  var AvatarUrl=AvatarUrlST;
} else {
...
class MessengerContainer extends Component {
  ...
  constructor(props) {
    ...
    this._messagesRef = new Firebase("https://chatreactapp-sotonekora.firebaseio.com");
    this._messages = [];
